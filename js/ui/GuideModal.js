...
2. **リチウム-6 備蓄の補充**:
   - ブランケットが増殖反応を行うにはリチウム-6 ($^6\\text{Li}$) が必要です。右カラムの「**備蓄補充 (+20 Li)**」を時折クリックして燃料切れを防ぎましょう。
...
- 右カラムの「**備蓄補充 (+20 Li, 100 MeV)**」ボタンを定期的に押し、常にリチウム備蓄を絶やさないようにすることが、安定した連続燃焼の秘訣です。
        `,
    },
    {
        id: 'checklist',
...
- [ ] **リチウム-6 備蓄はあるか？**
  - ステータスバーの「⁶Li備蓄」が 0 になっていませんか？ 0 なら「備蓄補充」をクリックしてください。
