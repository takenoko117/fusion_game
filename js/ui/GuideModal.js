...
3. **トカマク炉心へ注入 & 点火**:
   - 「注入: 重水素 ²H」と「注入: 三重水素 ³H」を押して炉心プラズマへ送り込みます。
   - **「⚡ 磁気パルス圧縮点火」** をクリック！
...
1. **自動連続注入トグルを ON**:
   ...
   - 手持ちの重水素(²H)と三重水素(³H)が常時トカマク炉心に補充され、核融合が連続して発生し続けます。
2. **海水からの重水素大量生産ラインを稼働**:
   - 海水には無尽蔵の重水素（約7000個に1個）が含まれています。
   - 「**💧 ギルドラー・サルファイド式 重水電解プラント**」(毎秒 +10 ²H)
   - 「**🏭 極低温液体水素 精密蒸留コンプレックス**」(毎秒 +100 ²H)
   - 「**🌊 海洋直接触媒抽出メガフロート群**」(毎秒 +1,000 ²H)
